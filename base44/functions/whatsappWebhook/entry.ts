...
const SITE_URL = 'https://trancosoresolve.com';
...
const LEAD_KEYWORDS = [
  ...
  'profissional', 'tem alguém', 'tem alguem', 'conhece alguém', 'conhece alguem',
  ...
  switch (intencao) {
    ...
    default: {
      const respostas = [
        ...
        `Olá! Obrigado pelo contato com a Trancoso Resolve 🌳\n\nAcesse nosso site: ${SITE_URL}\n\nPra eu te direcionar direito: você precisa de um profissional ou quer fazer parte da nossa vitrine de prestadores?`,
        `Oi! Recebemos sua mensagem 😊 Aqui é da Trancoso Resolve, a plataforma de serviços de Trancoso.\n\nSite: ${SITE_URL}\n\nMe conta rapidinho: você busca um serviço ou quer se cadastrar como prestador? 🌴`,
      ];
      return getRandomResponse(respostas);
    }
  }
