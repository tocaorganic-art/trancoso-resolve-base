          ...
          <footer className="text-white py-8 pb-safe bg-[hsl(var(--card))]" style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 2rem)" }}>
            <div className="container mx-auto px-4 text-center">
              ...
              <div className="flex justify-center gap-5 mb-4">
                <a href="https://www.instagram.com/trancosoresolve/" target="_blank" rel="noopener noreferrer" aria-label="Instagram da Trancoso Resolve" className="text-slate-400 hover:text-pink-400 transition-colors">
                ...
                <a href="https://www.facebook.com/share/1B7w8mmbMN/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" aria-label="Facebook da Trancoso Resolve" className="text-slate-400 hover:text-blue-400 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                </a>
                <a href="https://wa.me/5573998283579" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp da Trancoso Resolve" className="text-slate-400 hover:text-green-400 transition-colors">
          ...
          <div className="container mx-auto px-4 py-3">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="lg:hidden flex items-center gap-2">
                <Button variant="ghost" size="icon" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} data-testid="mobile-menu-button" aria-label="Abrir menu de navegação">
                  {mobileMenuOpen ? <X className="w-5 h-5" /> : <Menu className="w-5 h-5" />}
                </Button>
              </div>
            </div>
