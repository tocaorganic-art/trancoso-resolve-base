...
const SLIDES = [
  {
    id: "cliente",
    badge: "🌴 Profissionais da sua comunidade",
    headline: ["Contrate quem você conhece.", "Verificado.", "Com histórico real."],
    highlightIndex: 1,
    subtitle: "Diarista, eletricista, jardineiro, encanador e muito mais — na Costa do Descobrimento. Oportunidade que o governo não dá.",
    cta: { label: "Encontrar profissional agora", to: "/ServicosCategoria", icon: true },
  ...
  {
    id: "prestador",
    badge: "⚡ Vagas limitadas — garanta a sua",
    headline: ["Gere renda na", "Costa do Descobrimento.", "Você merece."],
    highlightIndex: 1,
    subtitle: "Cadastre-se, seja verificado e apareça pra quem precisa de você. Comece grátis por 30 dias.",
  ...
  {
    id: "empresa",
    badge: "Para pousadas, villas e empresas",
    headline: ["Serviços organizados.", "Prestadores confiáveis.", "Sem complicação."],
    highlightIndex: 0,
    subtitle: "Gerencie múltiplos prestadores, agenda centralizada e suporte prioritário. Atendemos toda a Costa do Descobrimento.",
    cta: { label: "Conheça os planos", to: "/Planos", icon: true },
