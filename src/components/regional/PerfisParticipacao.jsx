...
const PERFIS = [
  {
    ...
    icon: Search,
    title: "Cliente",
    desc: "Descubra serviços e profissionais locais com mais praticidade.",
    cta: "Saiba mais",
  },
  {
    key: "prestador",
    icon: Briefcase,
    title: "Prestador",
    desc: "Ganhe presença digital e seja encontrado por quem precisa.",
    cta: "Saiba mais",
  },
  {
    key: "lojista",
    icon: Store,
    title: "Lojista/Empresa",
    desc: "Apresente seu negócio a moradores e visitantes da região.",
    cta: "Saiba mais",
  },
];
