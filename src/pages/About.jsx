...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden py-20 px-4 bg-card border-b border-border">
        <div className="container mx-auto max-w-4xl relative">
          ...
          <Link to={createPageUrl('ServicosCategoria')}>
            <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold px-8 py-3 text-base">
      ...
      <section className="py-16 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-primary text-sm font-semibold uppercase tracking-widest">Nossa Missão</span>
              <h2 className="text-3xl font-bold mt-2 mb-4 text-foreground">Curadoria de experiências. Conexão de confiança.</h2>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mt-2 text-foreground">Tecnologia a serviço da excelência</h2>
          </div>
      ...
      <section className="py-16 px-4 bg-secondary/30 border-y border-border">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mt-2 text-foreground">Feito para Trancoso. Para todos.</h2>
          </div>
