  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">Manutenção do Sistema</h1>
      ...
      {/* Otimizações */}
      <div className="mb-6">
        <h2 className="text-xl font-bold text-foreground mb-4">Otimizações</h2>
        <CacheManager />
      </div>

      {/* Diagnósticos Detalhados */}
      <div className="mb-6">
        <h2 className="text-xl font-bold text-foreground mb-4">Diagnósticos em Tempo Real</h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <PerformanceMonitor />
          <NetworkMonitor />
        </div>
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
            <div className="bg-card p-3 rounded">
              ...
              <p className="text-muted-foreground">Falhas Críticas</p>
            </div>
            <div className="bg-card p-3 rounded">
              <p className="font-bold text-orange-600">99.95%</p>
