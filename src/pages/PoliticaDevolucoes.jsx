    ...
    <div className="min-h-screen bg-slate-900 text-white py-12 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">1. Escopo</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">2. Prazo de Arrependimento</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">3. Condições para Reembolso</h2>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">4. Exceções ao Reembolso</h2>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">5. Processo de Solicitação</h2>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">6. Cancelamento de Assinaturas</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">7. Prazos de Processamento</h2>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">8. Garantia de Satisfação</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">9. Disputas com Prestadores</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">10. Contato</h2>
          <p>
