  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white py-12 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">2. Descrição do Serviço</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">3. Registros e Contas</h2>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">4. Pagamentos e Preços</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>Preços podem ser alterados sem aviso prévio</li>
            <li>Todos os preços são em Real (BRL)</li>
            <li>Pagamentos são processados via Mercado Pago de forma segura (Pix e cartão de crédito)</li>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">5. Conduta do Usuário</h2>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">6. Responsabilidades dos Clientes</h2>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">7. Responsabilidades dos Prestadores</h2>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">8. Verificação e Segurança</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">9. Limitação de Responsabilidade</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">10. Avaliações e Comentários</h2>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">11. Propriedade Intelectual</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">12. Suspensão e Encerramento</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">13. Resolução de Disputas</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">14. Modificações dos Termos</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">15. Lei Aplicável</h2>
          <p>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-2xl font-bold text-blue-400">16. Contato</h2>
          <p>
            Para dúvidas sobre estes termos: <strong>suporte@trancosoresolve.com</strong>
          </p>
          <p className="text-sm text-slate-400 mt-4">Última atualização: 16 de maio de 2026</p>
        </section>
      </div>
    </div>
  );
