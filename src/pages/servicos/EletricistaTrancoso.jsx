...
export default function EletricistaTrancoso() {
  return (
    <ServicoLocalPage
      title="Eletricista em Trancoso, BA | Emergência e Manutenção Elétrica — Trancoso Resolve"
      keywords="eletricista Trancoso, eletricista Trancoso BA, eletricista emergência Trancoso, instalação elétrica Trancoso"
      canonicalUrl="https://trancosoresolve.com.br/servicos/eletricista-trancoso"
      schemaData={{
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Trancoso Resolve - Eletricista Trancoso",
        "description": "Eletricistas verificados em Trancoso, BA. Emergência, instalações e manutenção elétrica em residências e pousadas.",
